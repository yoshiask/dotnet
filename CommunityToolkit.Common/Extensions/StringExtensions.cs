...
public static class StringExtensions
{
...
#else
        System.Text.StringBuilder result = new(ret.Length);
    ...
    /// <summary>
    /// Concatenates the members of a constructed <see cref="IEnumerable{String}"/>
    ...
    /// -or- <see cref="string.Empty"/> if values has zero elements.
    /// </returns>
    ...
    /// <returns>
    /// <c>true</c> if the value parameter is <c>null</c> or <see cref="string.Empty"/>,
    /// or if value consists exclusively of white-space characters.
    /// </returns>
    /// <remarks>
    /// A polyfill from <see href="See https://referencesource.microsoft.com/#mscorlib/system/string.cs,55e241b6143365ef">.NET Framework 4.8</see>.
    /// </remarks>
